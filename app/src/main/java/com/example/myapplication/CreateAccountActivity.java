...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    void createAccount(){
        ...
        boolean inValidated = validateData(email,password,confirmPassword);
                ...
                new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            Utility.showToast(CreateAccountActivity.this, "Sucessfull crate account , check email to verify");
